...
/**
 * Created by Pankaj Vaghela on 30-04-2018.
 */
public class PermissionUtils
{
    ...
    public PermissionUtils(Context context, Context activity)
    {
    ...
    public void iniCheckBasicPermissions(){
...
//        permissions.add(Manifest.permission.ACCESS_COARSE_LOCATION);
        ...
        check_permission(permissions,"Please Enable this permission, or one or more functionality of App won't work",1);
    }

    public void iniCheckAdvPermissions(){
//        ArrayList<String> permissions=new ArrayList<>();
